...
void UVictoryBPFunctionLibrary::VictoryFloatPlusEquals(float& float_, float Add, float& FloatOut) {
}

void UVictoryBPFunctionLibrary::VictoryFloatMinusEquals(float& float_, float Sub, float& FloatOut) {
}
...
void UVictoryBPFunctionLibrary::OperatingSystem__GetCurrentPlatform(bool& Windows_, bool& Mac, bool& Linux, bool& IOS, bool& Android, bool& Android_ARM, bool& PS4, bool& XBoxOne, bool& HTML5, bool& APPLE) {
}
