...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, ReplicatedUsing=RepNotifyIsUsingRadio, meta=(AllowPrivateAccess=true))
    bool isUsingRadio;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, ReplicatedUsing=RepNotifySoundEffectAsset, meta=(AllowPrivateAccess=true))
    FString pathToSoundEffectAsset;
